...
Audited at: `2026-07-15T00:03:17.617Z`

Claims: `site\verify\claims\product-claims.json`

Evidence: `site\verify\evidence\evidence-manifest.json`
...
| Evidence-linked claims | 10 |
| Third-party claims | 0 |
| Reproducible claims | 10 |
| Time-proven claims | 0 |
| Unsupported claims | 0 |
| Total evidence items | 9 |
| External evidence items | 9 |
| First-party evidence items | 9 |
...
| --- | --- | --- |
| PASS | claims_manifest | Claims manifest loaded from site\verify\claims\product-claims.json. |
| PASS | evidence_manifest | Evidence manifest loaded from site\verify\evidence\evidence-manifest.json. |
...
| PASS | evidence:ev-parent-path-note:location | Evidence has at least one external/public location. |
| MANUAL_CHECK_REQUIRED | evidence:ev-parent-path-note:issuer | Evidence is first-party. This may be valid, but it is not independent evidence. |
| PASS | evidence:ev-parent-path-note:reproducibility | Evidence reproducibility is reproducible. |
| PASS | evidence:ev-parent-path-note:method_refs | Evidence links to a low-cost recheck method. |
...
| PASS | claim:cxt-parent-path-working-map:evidence | Claim references existing evidence. |
| PASS | claim:cxt-parent-path-working-map:limitations | Claim includes limitations. |
| PASS | claim:cxt-parent-path-working-map:scope | Claim includes explicit scope. |
| PASS | claim:cxt-parent-path-working-map:subject_coverage | All resolved evidence subject bindings match public_framework:civitasx-parent-framework. |
...
| PASS | cxt-parent-path-working-map | REPRODUCIBLE | L3_REPRODUCIBLE_METHOD | EXTERNAL_POLICY_REVIEW | not_declared | PASS | 1 | 1 | 0 |
...
| MANUAL_CHECK_REQUIRED | ev-parent-path-note | public_framework:civitasx-parent-framework | first_party | reproducible | yes | NOT_S2 | no | NOT_S3 | no | NOT_S4 | no |
